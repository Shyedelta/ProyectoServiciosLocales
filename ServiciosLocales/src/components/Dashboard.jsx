            ...
            <div className='flex justify-between overflow-hidden'>
                    ...
                    <aside id="sidebar-multi-level-sidebar" className="fixed w-[16em] h-[30em]" aria-label="Sidebar">
                        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 rounded-md">
                            <ul className="space-y-2 font-medium">
                                <li>
                                    <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group" onClick={() => handleMenuClick('dashboard')}>
                                ...
                                <li>
                                    <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group" onClick={() => handleMenuClick('inbox')}>
                                ...
                                <li>
                                    <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group" onClick={() => handleMenuClick('usuarios')}>
                                ...
                                <li>
                                    <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group" onClick={() => handleMenuClick('servicios')}>
                                ...
                                <li>
                                    <a href="#" className="flex items-center p-2 text-gray-500 hover:text-gray-800 rounded-lg hover:bg-gray-100 group" onClick={() => handleMenuClick('logout')}>
                ...
                <div className="m-10 ml-0 w-full max-w-[75%] overflow-hidden">
                    <div className="p-10 border-2 min-h-[65vh] w-full border-gray-200 border-dashed rounded-lg">
                        {contenido === 'dashboard' && <div>Dashboard 
                            <UsersEdit />
                            </div>}
                        ...
                        {/* <div className="grid grid-cols-3 gap-4 mb-4">
                            <div className="flex items-center justify-center h-24 rounded bg-gray-50/50 hover:bg-gray-50 ">
                        ...
                        <div className="flex items-center justify-center h-48 mb-4 rounded bg-gray-50/50 hover:bg-gray-50 ">
                            <p className="text-2xl text-gray-400 ">
                                <svg className="w-3.5 h-3.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 1v16M1 9h16" />
                                </svg>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            <div className="flex items-center justify-center rounded bg-gray-50/50 hover:bg-gray-50 h-28 ">
                                <p className="text-2xl text-gray-400 ">
                                    <svg className="w-3.5 h-3.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                                        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 1v16M1 9h16" />
                                    </svg>
