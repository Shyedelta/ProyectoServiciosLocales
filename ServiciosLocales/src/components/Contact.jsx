...
function Contact() {
    ...
    return (
        <div className="flex flex-col-reverse 2xl:flex-row min-h-screen border-x ">
            <div className="w-full h-full bg-gray-100 px-6 py-24 grid place-content-center">
                <div className="px-10 overflow-hidden">
                    <div>
                        <h2 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-4xl">Estamos aquí para ayudarte</h2>
                        <p className="my-10 text-lg leading-8 text-gray-600">¡Ponte en contacto con nosotros! Estamos aquí para ayudarte en lo que necesites.</p>
                    </div>
            ...
            <div className="bg-white px-10 py-24 w-full ">
