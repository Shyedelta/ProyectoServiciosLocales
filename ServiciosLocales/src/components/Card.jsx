            ...
            {empresa &&
                <div className=" min-h-[30em] bg-white group overflow-hidden border-gray-200 rounded-lg shadow ">
                    ...
                    <div className="p-5 h-[15em] flex flex-col justify-around">
                        ...
                        <Link to={`/servicio/id/${empresa.id}`} className="inline-flex w-max items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 ">
                            Ver más
