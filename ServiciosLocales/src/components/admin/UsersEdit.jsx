        ...
        <div className='bg-white/20 p-5 px-6 rounded-2xl w-full'>
            <form onSubmit={handleSubmit}>
                ...
                <div className="flex justify-between">
                    ...
                    <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center" > Guardar
                    </button>
                </div>
            </form>
        </div>
