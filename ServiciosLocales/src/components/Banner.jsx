...
function Banner() {
    ...
    return (
        <div className='*:select-none w-full shadow-lg text-white flex'>
            {!showContent ? (
                <div className="flex w-full h-full min-h-[29em] items-center justify-center max-w-screen-xl text-center py-20 bg-gray-700  ">
                ...
                <section className={` bg-center bg-no-repeat bg-[url('./imgs/toledo.jpg')] bg-gray-700 bg-blend-multiply`}>
                    <div className=" mx-auto max-w-screen-xl text-center py-20">
                        ...
                        <div className="scale-in-top flex space-y-4 flex-row justify-center">
