        ...
        <div className="bg-white">
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                <div className="flex justify-between">
                    <h2 className="text-2xl font-bold tracking-tight text-gray-700">Servicios más visitados</h2>
                ...
                <div className="mt-6 grid lg:grid-cols-3 grid-cols-1  gap-x-6 gap-y-6 ">
                    {empresas.slice(7, 10).map((empresa) => {
...
export default SectionServicesDesc