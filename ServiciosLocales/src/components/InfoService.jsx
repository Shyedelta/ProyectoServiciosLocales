        ...
        <>
            <div className="px-10 mt-10 gap-3 h-max p-3 w-full grid grid-rows-1 lg:grid-cols-3 place-items-center">
                ...
                <div className='w-full overflow-hidden p-5 gap-5 rounded-xl bg-blue-400 grid grid-cols-2 content-between'>
                    ...
                    <span onClick={() => { setOpenModalMsg(true) }} className=" justify-self-end w-20 cursor-pointer inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
