...
function Valoraciones({empresa}) {
    return (
        <div>
            <div className="flex-col shadow-md rounded-xl flex items-center justify-center pointer-events-none">
                {empresa && <p className='text-center text-white text-[4vw] px-2 font-extralight my-10'>{empresa.nombre}</p>}
